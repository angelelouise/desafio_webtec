...
function App() {
    ...
    const [cepInput, setCepInput] = useState<any>(null);
            ...
            <Row className="justify-content-md-center">
                <Form>
                    <Form.Group>
                        ...
                        <Row>
                            <input type="textarea" id="input_cep" onChange={handleChangeCep}/>
                        </Row>
                        <br/>
                        <Row>
                            <Button id="consultar" type="button" onClick={handleInput}>Consultar</Button>
                        </Row>
                        <br/>
                    </Form.Group>
                </Form>
